...
--
-- Servidor: 10.200.9.105
-- Tiempo de generación: 13-12-2021 a las 13:55:14
-- Versión del servidor: 10.2.39-MariaDB-10.2.39+maria~stretch-log
...
--
-- Base de datos: `dotclear324b`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dc_blog`
--
...
--
-- Volcado de datos para la tabla `dc_blog`
--

INSERT INTO `dc_blog` (`blog_id`, `blog_uid`, `blog_creadt`, `blog_upddt`, `blog_url`, `blog_name`, `blog_desc`, `blog_status`) VALUES
('default', '2debd74bdb02968d9c669740583464cf', '2021-12-13 12:43:47', '2021-12-13 12:43:48', 'http://www.lordtiranus.com.mialias.net/dotclear/index.php?', 'My first blog', NULL, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dc_category`
--
...
--
-- Estructura de tabla para la tabla `dc_comment`
--
...
--
-- Volcado de datos para la tabla `dc_comment`
--
...
(1, 1, '2021-12-13 12:43:47', 'Europe/London', '2021-12-13 12:43:47', 'Dotclear Team', 'contact@dotclear.net', 'https://dotclear.org/', '<p>This is a comment.</p>\n<p>To delete it, log in and view your blog\'s comments. Then you might remove or edit it.</p>', 'this comment delete log and view your blog comments then you might remove edit', '90.167.167.107', 1, '0', NULL, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dc_link`
--
...
--
-- Estructura de tabla para la tabla `dc_log`
--
...
--
-- Estructura de tabla para la tabla `dc_media`
--
...
--
-- Estructura de tabla para la tabla `dc_meta`
--
...
--
-- Estructura de tabla para la tabla `dc_notice`
--
...
--
-- Estructura de tabla para la tabla `dc_permissions`
--
...
--
-- Estructura de tabla para la tabla `dc_ping`
--
...
--
-- Estructura de tabla para la tabla `dc_post`
--
...
--
-- Volcado de datos para la tabla `dc_post`
--
...
(1, 'default', 'LordSithCanRa', NULL, '2021-12-13 12:43:00', 'Europe/London', '2021-12-13 12:43:47', '2021-12-13 12:43:47', NULL, 'post', 'xhtml', '2021/12/13/Welcome-to-Dotclear!', 'es', 'Welcome to Dotclear!', NULL, '', '<p>This is your first entry. When you\'re ready to blog, log in to edit or delete it.</p>', '<p>This is your first entry. When you\'re ready to blog, log in to edit or delete it.</p>', NULL, NULL, 'welcome dotclear this your first entry when you ready blog log edit delete', 1, 1, 0, 0, 1, 0, 1, 0),
(2, 'default', 'LordSithCanRa', NULL, '2021-12-13 12:43:00', 'Europe/London', '2021-12-13 12:43:48', '2021-12-13 12:43:48', NULL, 'page', 'xhtml', '2021/12/13/My-first-page', 'es', 'My first page', '', '', '<p>This is your first page. When you\'re ready to blog, log in to edit or delete it.</p>', '<p>This is your first page. When you\'re ready to blog, log in to edit or delete it.</p>', NULL, NULL, 'first page this your first page when you ready blog log edit delete', -2, 0, 0, 0, 0, 0, 0, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dc_post_media`
--
...
--
-- Estructura de tabla para la tabla `dc_pref`
--
...
--
-- Volcado de datos para la tabla `dc_pref`
--
...
('favorites', 'LordSithCanRa', 'dashboard', '[]', 'array', NULL),
...
('quickentry', 'LordSithCanRa', 'dashboard', '0', 'boolean', ''),
('unfolded_sections', NULL, 'toggles', '', 'string', 'Folded sections in admin');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dc_session`
--
...
--
-- Volcado de datos para la tabla `dc_session`
--

INSERT INTO `dc_session` (`ses_id`, `ses_time`, `ses_start`, `ses_value`) VALUES
('3114b69641f9a83f473ae301f4fe7c0072b9282a', 1639399590, 1639399478, 'sess_user_id|s:13:\"LordSithCanRa\";sess_browser_uid|s:40:\"7a1c8ad44bb32822af5f541aa2b0f49514a3a3fb\";sess_blog_id|s:7:\"default\";');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dc_setting`
--
...
--
-- Volcado de datos para la tabla `dc_setting`
--
...
('lang', 'default', 'system', 'es', 'string', 'Default blog language'),
...
('antispam_date_last_purge', 'default', 'antispam', '1639399615', 'integer', 'Antispam Date Last Purge (unix timestamp)');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dc_spamrule`
--
...
--
-- Volcado de datos para la tabla `dc_spamrule`
--
...
--
-- Estructura de tabla para la tabla `dc_user`
--
...
--
-- Volcado de datos para la tabla `dc_user`
--
...
('LordSithCanRa', 1, 1, '$2y$10$H0axzcZofNuuCyUCt3RgiOiway1eaua5RuzM2otqDfUVTUQwzKyVW', 0, NULL, 'Canelo Arévalo', 'Ramón', NULL, 'rcaneloarevalo@gmail.com', NULL, NULL, NULL, 'a:5:{s:9:\"edit_size\";i:24;s:14:\"enable_wysiwyg\";b:1;s:14:\"toolbar_bottom\";b:0;s:6:\"editor\";a:2:{s:5:\"xhtml\";s:10:\"dcCKEditor\";s:4:\"wiki\";s:14:\"dcLegacyEditor\";}s:11:\"post_format\";s:5:\"xhtml\";}', 'es', 'Europe/London', -2, '2021-12-13 12:43:47', '2021-12-13 12:43:47');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dc_version`
--
...
--
-- Volcado de datos para la tabla `dc_version`
--
...
--
-- Indices de la tabla `dc_category`
--
...
--
-- Indices de la tabla `dc_comment`
--
...
--
-- Indices de la tabla `dc_permissions`
--
...
--
-- Indices de la tabla `dc_ping`
--
ALTER TABLE `dc_ping`
  ADD PRIMARY KEY (`post_id`,`ping_url`);

--
-- Indices de la tabla `dc_post`
--
ALTER TABLE `dc_post`
...
--
-- Indices de la tabla `dc_post_media`
--
...
--
-- Indices de la tabla `dc_session`
--
ALTER TABLE `dc_session`
  ADD PRIMARY KEY (`ses_id`);

--
-- Indices de la tabla `dc_setting`
--
...
--
-- Indices de la tabla `dc_spamrule`
--
...
--
-- Indices de la tabla `dc_version`
--
...
--
-- Filtros para la tabla `dc_post_media`
--
ALTER TABLE `dc_post_media`
